...
-- 6. 既存データのscenario_idを更新（シナリオタイトルからマッチング）
...
DO $$
BEGIN
    RAISE NOTICE 'Safe database setup completed successfully!';
