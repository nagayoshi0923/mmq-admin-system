...
('ユウト', 'ユウト@MMQ', '@yuto_mmq', ARRAY['GM'], ARRAY['別館①'], ARRAY['なし']::text[], ARRAY['音響技術'], ARRAY['雪山の遭難', '宇宙船の謎'], '音響・照明担当', '090-8901-2345', 'yuto@mmq.com', ARRAY['全日'], 3, ARRAY['技術系'], 'active'),
...
('ケンタ', 'ケンタ@MMQ', '@kenta_mmq', ARRAY['社長'], ARRAY['馬場', '大久保', '別館①'], ARRAY['なし']::text[], ARRAY['経営戦略'], ARRAY['全シナリオ対応可能'], '代表取締役', '090-0123-4567', 'kenta@mmq.com', ARRAY['全日'], 5, ARRAY['経営系'], 'active');
